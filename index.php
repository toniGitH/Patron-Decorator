...
<body>
    <div class="container">
        ...
        <main class="scenarios-grid">
            <?php 
            // El objeto $client ya ha sido instanciado en main.php
            $delay = 0;
            foreach ($scenariosData as $key => $data): 
                $delay += 0.1;
            ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="scenario-full-meta" style="grid-column: 1 / -1; margin-bottom: 2rem; padding-bottom: 2rem; border-bottom: 1px solid var(--border);">
                            <p style="font-size:0.95rem; color:var(--text-muted); margin-bottom:0.75rem;">
                                <strong>Descripción del escenario:</strong> <span style="color:var(--text-main);"><?= $data['situation'] ?></span>
                            </p>
                            <p style="font-size:0.95rem; color:var(--text-muted); margin-bottom:0.75rem;">
                                <strong>Nivel de riesgo:</strong> <span style="color:var(--text-main);"><?= $data['risk_analysis'] ?></span>
                            </p>
                            <p style="font-size:0.95rem; color:var(--text-muted); margin-bottom:1.5rem;">
                                <strong>Acciones a realizar:</strong> <span style="color:var(--text-main);"><?= $data['intervention_expl'] ?></span>
                            </p>
                        </div>
